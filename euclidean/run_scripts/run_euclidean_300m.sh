...
CHECKPOINT_PATH="${CHECKPOINT_PATH:-${REPO_DIR}/outputs/euclidean_300m_checkpoints}"
TENSORBOARD_LOGS_PATH="${TENSORBOARD_LOGS_PATH:-${REPO_DIR}/outputs/tensorboard/euclidean_300m}"
