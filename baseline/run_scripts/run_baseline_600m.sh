...
###############################################################################
# Baseline 600M run script
#
# This script corresponds to the FP32 baseline used in the paper.
...
CHECKPOINT_PATH="${CHECKPOINT_PATH:-${REPO_DIR}/outputs/baseline_600m_checkpoints}"
TENSORBOARD_LOGS_PATH="${TENSORBOARD_LOGS_PATH:-${REPO_DIR}/outputs/tensorboard/baseline_600m}"
