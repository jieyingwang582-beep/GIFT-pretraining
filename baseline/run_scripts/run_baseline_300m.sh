...
###############################################################################
# Baseline 300M run script
#
# This script corresponds to the 300M baseline configuration used in the paper.
...
CHECKPOINT_PATH="${CHECKPOINT_PATH:-${REPO_DIR}/outputs/baseline_300m_checkpoints}"
TENSORBOARD_LOGS_PATH="${TENSORBOARD_LOGS_PATH:-${REPO_DIR}/outputs/tensorboard/baseline_300m}"
...
srun \
  ...
  bash -lc "
    ...
    CMD_STR_NODE=\"\${CMD_STR//__NODE_RANK__/\$NODE_RANK}\"
