...
CHECKPOINT_PATH="${CHECKPOINT_PATH:-${REPO_DIR}/outputs/gift_600m_checkpoints}"
TENSORBOARD_LOGS_PATH="${TENSORBOARD_LOGS_PATH:-${REPO_DIR}/outputs/tensorboard/gift_600m}"
